package com.team6.spacesim.Demoscene.Managers;
...
import com.team6.spacesim.interfaces.CollisionResolver;

public class CircleCollision implements CollisionResolver {
    ...
    public CircleCollision(float worldWidth, float worldHeight) {
